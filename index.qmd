...
[Source Code](https://github.com/emilhvitfeldt/quarto-arrows/blob/main/examples/basic.qmd){.btn .btn-secondary}
...
[Source Code](https://github.com/emilhvitfeldt/quarto-arrows/blob/main/examples/styling.qmd){.btn .btn-secondary}
...
[Source Code](https://github.com/emilhvitfeldt/quarto-arrows/blob/main/examples/arrowheads.qmd){.btn .btn-secondary}
...
[Source Code](https://github.com/emilhvitfeldt/quarto-arrows/blob/main/examples/linestyles.qmd){.btn .btn-secondary}
...
[View Example](examples/labels.html){.btn .btn-primary}
[Source Code](https://github.com/emilhvitfeldt/quarto-arrows/blob/main/examples/labels.qmd){.btn .btn-secondary}

<iframe src="examples/labels.html" width="100%" height="400" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>

### Advanced Curves

Simple curve parameter instead of manual control points.

[View Example](examples/curves.html){.btn .btn-primary}
[Source Code](https://github.com/emilhvitfeldt/quarto-arrows/blob/main/examples/curves.qmd){.btn .btn-secondary}

<iframe src="examples/curves.html" width="100%" height="400" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>
...
[Source Code](https://github.com/emilhvitfeldt/quarto-arrows/blob/main/examples/positioned.qmd){.btn .btn-secondary}
...
[Source Code](https://github.com/emilhvitfeldt/quarto-arrows/blob/main/examples/revealjs.qmd){.btn .btn-secondary}
...
| PDF | Full support | Uses TikZ ([example](examples/pdf.qmd)) |
| Typst | Full support | Uses CeTZ ([example](examples/typst.qmd)) |
| RevealJS | Full support | Draw animations ([example](examples/revealjs.qmd)) |
...
- [quarto-leader-line](https://github.com/ofkoru/quarto-leader-line) - Draw arrows between HTML elements using LeaderLine.js

## Links

- [GitHub Repository](https://github.com/emilhvitfeldt/quarto-arrows)
- [Report Issues](https://github.com/emilhvitfeldt/quarto-arrows/issues)
